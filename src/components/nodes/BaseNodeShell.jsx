...
const styles = {
  ...
  body: { padding: '10px 0', background: '#fafafa', minHeight: '40px', borderBottomLeftRadius: '8px', borderBottomRightRadius: '8px' },
  inputHandleWrapper: { position: 'absolute', top: '62px', left: 0, zIndex: 50 },
  inputHandle: { left: '-6px', width: '12px', height: '12px', background: '#555', border: '2px solid #fff', borderRadius: '50%' }
};
